...
class HSD_Dll_Wrapper:
    ...
    def __init__(self):
        ...
        dllabspath = os.path.dirname(os.path.abspath(__file__)) + os.path.sep + "libhs_datalog"
        os.environ['PATH'] = dllabspath + os.pathsep + os.environ['PATH']
        self._hsd_dll = cdll.LoadLibrary(util.find_library("libhs_datalog"))
...
class HSD_Dll:
    ...
    def hs_datalog_send_message(self, dId : int, msg : str, msg_len : int) -> [bool, int, str]:
        ...
        return [self.hsd_wrapper.hs_datalog_send_message(dIdC, msgC, msg_lenC, ctypes.byref(data_lenC), ctypes.byref(dataC)) == ST_HS_DATALOG_OK, data_lenC, dataC]
    ...
    def hs_datalog_set_ODR(self, dId : int, sId : int, ssId : int, odr : float) -> bool:
        ...
        return (self.hsd_wrapper.hs_datalog_set_ODR(dIdC, sIdC, ssIdC, odrC) == ST_HS_DATALOG_OK)
    ...
    def hs_datalog_get_ODR(self, dId : int, sId : int, ssId : int) -> [bool, float]:
        ...
        return (self.hsd_wrapper.hs_datalog_get_ODR(dIdC, sIdC, ssIdC, odrC) == ST_HS_DATALOG_OK, odrC)
    ...
    def hs_datalog_get_measured_ODR(self, dId : int, sId : int, ssId : int) -> [bool, float]:
        ...
        return (self.hsd_wrapper.hs_datalog_get_measured_ODR(dIdC, sIdC, ssIdC, odrMC) == ST_HS_DATALOG_OK, odrMC)
    ...
    def hs_datalog_get_initial_offset(self, dId : int, sId : int,  ssId : int) -> [bool, float]:
        ...
        return (self.hsd_wrapper.hs_datalog_get_initial_offset(dIdC, sIdC, ssIdC, offset) == ST_HS_DATALOG_OK, offset)
    ...
    def hs_datalog_get_FS(self, dId : int, sId : int, ssId : int) -> [bool, float]:
        ...
        return (self.hsd_wrapper.hs_datalog_get_FS(dIdC, sIdC, ssIdC, fsC) == ST_HS_DATALOG_OK, fsC)
    ...
    def hs_datalog_get_samples_per_timestamp(self, dId : int, sId : int, ssId : int) -> [bool, int]:
        ...
        ssIdC = ctypes.c_int(ssId)
        sptC = ctypes.c_int(0)
        return (self.hsd_wrapper.hs_datalog_get_samples_per_timestamp(dIdC, sIdC, ssIdC, sptC) == ST_HS_DATALOG_OK, sptC)
    ...
    def hs_datalog_get_sub_sensor_active(self, dId : int, sId : int, ssId : int) -> [bool, bool]:
        ...
        return (self.hsd_wrapper.hs_datalog_get_sub_sensor_active(dIdC, sIdC, ssIdC, activeC) == ST_HS_DATALOG_OK, activeC)
    ...
    def hs_datalog_get_available_data_size(self, dId : int, sId : int, ssId : int) -> [bool, int]:
        ...
        return (self.hsd_wrapper.hs_datalog_get_available_data_size(dIdC, sIdC, ssIdC, available_dataC) == ST_HS_DATALOG_OK, available_dataC.value)
