...
class STWINHSDGetCmd(STWINHSDCmd):
    ...
    def from_dict(self, obj: Any) -> 'STWINHSDGetCmd':
        #TODO check also that from_dict is working (need to use something like super as per to_dict)
        assert isinstance(obj, dict)
...
@dataclass
class STWINHSDGetDescriptorCmd(STWINHSDGetCmd):
    def __init__(self):
        self.command = "GET"
...
@dataclass
class STWINHSDGetStatusCmd(STWINHSDGetCmd):
    def __init__(self):
        self.command = "GET"
        self.request = "status"
...
@dataclass
class STWINHSDGetSensorStatusCmd(STWINHSDGetSensorCmd):
    def __init__(self, sensor_id: int):
        self.command = "GET"
        self.request = "status"
        self.sensorId = sensor_id
...
@dataclass
class STWINHSDGetNetworkInfoCmd(STWINHSDGetCmd):
    def __init__(self):
        self.command = "GET"
...
@dataclass
class STWINHSDGetRegisterCmd(STWINHSDGetCmd):
    def __init__(self):
        self.command = "GET"
...
@dataclass
class STWINHSDSetWiFiCmd(STWINHSDSetCmd):
    ssid: str
    password: str
    enable: bool

    def __init__(self, ssid: str, password: str, enable: bool):
        self.command = "SET"
        self.request = "network"
        self.ssid = ssid
    ...
    @staticmethod
    def from_dict(self, obj: Any) -> 'STWINHSDSetWiFiCmd':
        # TODO check also that from_dict is working (need to use something like super as per to_dict)
        assert isinstance(obj, dict)
        ssid = from_str(obj.get("ssid"))
        password = from_str(obj.get("password"))
        enable = from_bool(obj.get("enable"))
        return STWINHSDSetWiFiCmd(ssid, password, enable)

    def to_dict(self) -> dict:
        result: dict = {}
        result.update(super(STWINHSDSetWiFiCmd, self).to_dict())
        result["ssid"] = from_str(self.ssid)
...
class STWINHSDSetSWTagLabelCmd(STWINHSDSetCmd):
    ...
    def to_dict(self) -> dict:
        ...
        result["ID"] = from_int(self.tag_id)
        result["enable"] = from_str(self.label)
        return result
...
@dataclass
class MLCConfigParam(STWINHSDSubSensorStatusParam):
    mlcConfigSize: int
    mlcConfigData: str
    ...
    def from_dict(self, obj: Any) -> 'MLCConfigParam':
        assert isinstance(obj, dict)
        ss_id = from_int(obj.get("id"))
        mlcConfigSize = from_int(obj.get("mlcConfigSize"))
        mlcConfigData = from_str(obj.get("mlcConfigData"))
        return MLCConfigParam(mlcConfigSize, mlcConfigData)

    def to_dict(self) -> dict:
        result: dict = {}
        result.update(super(MLCConfigParam, self).to_dict())
        result["id"] = from_int(self.sensor_id)
