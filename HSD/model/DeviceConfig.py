...
#
#     result = device_config_from_dict(json.loads(json_string))
...
class SubSensorStatus:
    ...
    def from_dict(obj: Any) -> 'SubSensorStatus':
        ...
        return SubSensorStatus(is_active, odr, odr_measured, initial_offset, samples_per_ts, fs, sensitivity, usb_data_packet_size, sd_write_buffer_size, wifi_data_packet_size, com_channel_number)
